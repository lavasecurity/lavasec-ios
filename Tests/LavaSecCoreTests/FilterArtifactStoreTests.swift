...
final class FilterArtifactStoreTests: XCTestCase {
    func testArtifactKindRawValuesRemainStableForPersistedManifests() {
        XCTAssertEqual(FilterArtifactKind.prepared.rawValue, "prepared")
        XCTAssertEqual(FilterArtifactKind.compact.rawValue, "compact")
    }
