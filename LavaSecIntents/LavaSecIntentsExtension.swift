...
// (in FocusFilterIntent.swift); its `perform()` drives the shared LavaSecFilterPipeline headless switch
// engine via `FocusSwitchEnvironment.performSwitch`, then signals the always-on tunnel to reload (P4d).
//
