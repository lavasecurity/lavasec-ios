...
public struct BackgroundWarmIndex: Codable, Equatable, Sendable {
    ...
    public var entries: [String: BackgroundWarmIndexEntry]
    ...
    public mutating func setEntry(_ entry: BackgroundWarmIndexEntry, forFilterID id: String) {
        entries[id] = entry
    }

    public mutating func removeEntry(forFilterID id: String) {
        entries[id] = nil
    }
    ...
    public func retainedTokens() -> [String] { entries.values.map(\.token) }
}
