...
// Bridges the catalog's parse-format MODEL (LavaSecKit) to the parser's format enum.
// Lives with the parser so the Kit model does not depend on the engine layer.
extension CatalogBlocklistSource.CatalogParseFormat {
